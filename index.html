...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../assets/img/bg_image_1.jpg)">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="#blog" class="nav-link" data-animate="scrolling">Service</a>
            </li>
            <li class="nav-item">
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">NDEYE COUMBA</b> GUEYE</h1>
      <div class="badge">Développeur & Web Designer</div>
  ...
  <div class="vg-page page-about" id="about">
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="../assets/img/Thiate.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Ndeye Coumba Gueye</h1>
          <h5 class="fg-theme mb-3">Développeur & Web Designer</h5>
          <p class="text-muted">Etudiante en Multimédia et Communication Digital</p>
          <ul class="theme-list">
            <li><b>Nationalité:</b> Sénégalaise</li>
            <li><b>Ville:</b> Kaolack</li>
            <li><b>Age:</b> 26</li>
            <li><b>Genre:</b> Femme</li>
          </ul>
    ...
    <div class="container py-5">
      ...
      <div class="row py-3">
        <div class="col-md-6">
          <div class="px-lg-3">
            ...
            <div class="progress-wrapper wow fadeInUp">
              ...
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 15%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">15%</div>
              </div>
            </div>
            <div class="progress-wrapper wow fadeInUp">
        ...
        <div class="col-md-6">
          <div class="px-lg-3">
            <h4 class="wow fadeInUp">Compétences de conception</h4>
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Design de Communication</span>
              <div class="progress">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Conception de logo,Affiche,Flyers
              </span>
              <div class="progress">
    ...
    <div class="container pt-5">
      <div class="row">
        <div class="col-md-6 wow fadeInRight">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              ...
              <div class="details">
                <h5>Diplôme Fin d'étude moyennes (BFEM)</h5>
                <small class="fg-theme">Lycée de Ndoffane</small>
            ...
            <li>
              ...
              <div class="details">
                <h5>Diplôme de Baccalauréat (BAC)</h5>
                <small class="fg-theme">Lycée Valdiodio Ndiaye</small>
            ...
            <li>
              ...
              <div class="details">
                <h5>Diplôme de Licence 3 en Multimédia Internet et Communication</h5>
                <small class="fg-theme">A L'University Virtuelle Du Sénégal (UVS)</small>
        ...
        <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              <div class="title">2021 - Actuel</div>
              <div class="details">
                <h5>Formation Accélérée en Dévelloppent Web et Mobile</h5>
                <small class="fg-theme">ESTEL</small>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              <h4 class="fg-theme">Création de sites web</h4>
              <p>je sais créé des site à partir de wordpress , bootstrap...</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              <h4 class="fg-theme">Infongraphie</h4>
              <p>Création des Logo, Affiche, Flyers...</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
    ...
    <div class="container">
      <div class="row section-counter">
        <div class="col-md-6 col-lg-3 py-4 wow fadeIn">
          <h1 class="number" data-number="32"></h1>
          <span>Project Compleate</span>
        </div>
       
        <div class="col-md-6 col-lg-3 py-4 wow fadeIn">
          <h1 class="number" data-number="5"></h1>
